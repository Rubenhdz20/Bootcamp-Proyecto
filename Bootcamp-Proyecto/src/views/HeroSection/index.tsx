import { useState } from 'react'; // useState for menu stat
    ...
    return(
        <>
            <div className="w-full h-full">
                <div className="mt-6 flex items-center px-12">
                    ...
                    <p className="ml-7 text-black text-xl font-black leading-10">MyFitnessWeb</p>
                </div>
